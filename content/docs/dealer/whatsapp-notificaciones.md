...
relatedRoutes: ["/solicitudes", "/api/public/solicitudes", "/api/solicitudes/[id]"]
entity: "solicitud"
order: 30
status: "active"
category: "tecnico"
...
Esta guia describe las notificaciones WhatsApp automaticas del modulo Dealer para solicitudes creadas desde la landing publica y gestionadas en la pantalla `/solicitudes`.
...
### 2. Cambio de estado desde /solicitudes
