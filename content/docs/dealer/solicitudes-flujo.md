...
module: "dealer"
screen: "/solicitudes"
summary: "Como gestionar las solicitudes de clientes que llegan desde la web: repuestos, servicios tecnicos y consultas comerciales."
roles: ["admin", "gerente", "usuario"]
tags: ["solicitudes", "dealer", "repuesto", "servicio", "comercial", "kanban"]
relatedRoutes: ["/solicitudes"]
entity: "solicitud"
order: 10
status: "active"
category: "usuario"
...
1. Entrar a `Solicitudes` desde el menu lateral.
