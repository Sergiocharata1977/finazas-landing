          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {SECTIONS.map(section => {
              ...
              return (
                <Card
                  key={section.id}
                  className={`hover:shadow-md transition-all duration-200 overflow-hidden group border-0 shadow-sm ${borderColor}`}
                >
            ...
            {EXTRA_SECTIONS.map(section => {
              ...
              return (
                <Link key={section.id} href={section.href}>
                  <Card className="hover:shadow-md transition-shadow cursor-pointer h-full border-dashed hover:border-solid border-0 shadow-sm">
